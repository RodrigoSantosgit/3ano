...
namespace IHCProject
{
    public class ViewModel
    {
        ...
        public List<AnualValues> DataSound { get; set; }
        public List<MonthValues> DataSoundMonth { get; set; }
        public ViewModel()
        {
            ...
            DataSound = new List<AnualValues>()
            {
                new AnualValues {Month = "JAN", Value = 30},
                new AnualValues {Month = "FEB", Value = 39},
                new AnualValues {Month = "MAR", Value = 47},
                new AnualValues {Month = "APR", Value = 42},
                new AnualValues {Month = "MAY", Value = 35}
            };

            DataSoundMonth = new List<MonthValues>()
            {
                new MonthValues {Day = "1", Value = 38},
                new MonthValues {Day = "2", Value = 37},
                new MonthValues {Day = "3", Value = 43},
                new MonthValues {Day = "4", Value = 45},
                new MonthValues {Day = "5", Value = 46},
                new MonthValues {Day = "6", Value = 33},
                new MonthValues {Day = "7", Value = 49},
                new MonthValues {Day = "8", Value = 35},
                new MonthValues {Day = "9", Value = 49},
                new MonthValues {Day = "10", Value = 47},
                new MonthValues {Day = "11", Value = 35},
                new MonthValues {Day = "12", Value = 31},
                new MonthValues {Day = "13", Value = 30},
                new MonthValues {Day = "14", Value = 48},
                new MonthValues {Day = "15", Value = 40}
            };
        }
    }
}
